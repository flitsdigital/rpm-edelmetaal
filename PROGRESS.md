...
| 22 | **Magic link i.p.v. wachtwoord** | Het wachtwoordveld in de export kwam van Memberstack, en het reset-scherm daar is een onafgemaakte placeholder ("Step 1 of 4"). De hashes migreren niet mee, dus alle drie de gebruikers moeten toch opnieuw instellen. Geen wachtwoord = niets om te bewaren, te resetten of te lekken. | 03-08-2026 |
...
| 5 | **3 gebruikers uitnodigen** (Supabase → Authentication → Users → Invite). Wachtwoord-hashes komen niet uit Memberstack, dus vooraf mailen — anders lijkt de invite op phishing. Daarna één keer echt inloggen en controleren dat de zakelijke prijzen laden: dat pad is nog niet gedraaid. | Jordi |
